        ...
        <div class="commande-container">
            ...
            <div class=" flex flex-col sm:justify-center items-center sm:pt-0 bg-gray-100 dark:bg-gray-900">
                <div class="w-full sm:max-w-xl mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                    <form method="POST" action="{{ route('order.process.address') }}" class="address-form">
                        @csrf
                ...
                <div class="w-full mr-3 mb-4">
                    ...
                    <x-text-input id="rue" class="block mt-1 w-full" type="text" name="address_street" autofocus autocomplete="address_street" />
                    <x-input-error :messages="$errors->get('rue')" class="mt-2" />
                </div>

                <div class="w-full mr-3 mb-4">
                    <x-input-label for="address_city" value="ville" />
                    <x-text-input id="ville" class="block mt-1 w-full" type="text" name="address_city" autofocus autocomplete="address_city" />
                ...
                <div class="w-full flex flex-row gap-2 mb-4 mt-4 justify-between">
                    <div>
                        ...
                        <x-text-input id="cp" class="block mt-1 w-full" type="text" name="address_zip" autofocus autocomplete="address_zip" />
                        <x-input-error :messages="$errors->get('cp')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="address" value="Département" />
                        <x-select id="department" class="block mt-1 w-full" name="address_department" autofocus autocomplete="address_department" list="addressdepartmentlist">
